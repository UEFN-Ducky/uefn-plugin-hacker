#!/usr/bin/env python3
"""Zip + publish hacker to the UEFN Ducky Store via uds_release.
...
Usage:
  ...
  py scripts/release.py --publish --changelog "v1: Hacker theme"
"""
...
def main() -> None:
    ...
    parser.add_argument("--sync-seed", action="store_true", help="Sync into frontend/uefn_plugins/hacker")
